report 50114 "4HC SVAT Invoice"
{
    UsageCategory = None;
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Layouts/SVAInvoice.rdl';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                if "Posting Date" < 20220601D then begin
                    ...
                    if "Posting Date" < 20220901D then begin
                        TaxLbl := 'VAT 12%';
                        SvatPct := 12;
                    end
                    else
        ...
        layout
        {
            area(content)
            {
                field("E-Mail Signature"; ShowEmailSignature)
                {
                    ...
                    ToolTip = 'Specifies whether to show the E-Mail signature on the report.';
                }
            }
        }
    }
