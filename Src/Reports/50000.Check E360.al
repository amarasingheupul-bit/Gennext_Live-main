report 50115 "Check WQ"
{
    // version NAVW113.00

    DefaultLayout = RDLC;
    RDLCLayout = 'Src\Reports\50000.Check E360.rdl';
    Caption = 'Cheque';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            column(CompanyReg; CompanyInfo."Registration No.")
            {

            }
            column(Narration_GenJnlLine; Narration)
            {

            }
            column(Counterfiet; Counterfiet)
            {
            ...
            column(PostingDate_GenJnlLine; "Posting Date")
            {
            ...
            column(NoCompanySeal; NoCompanySeal)
            {
            ...
            column(NoOfValidDays; NoOfValidDays)
            {

            }
            column(NoOfValidDaysTxt; NoOfValidDaysTxt)
            {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(DescriptionLine3; DescriptionLine[3])
                    {
                    }
                    ...
                    column(Cheque_day1; Cheque_day1)
                    {

                    }
                    column(Cheque_day2; Cheque_day2)
                    {

                    }
                    column(Cheque_month1; Cheque_month1)
                    {

                    }
                    column(Cheque_month2; Cheque_month2)
                    {

                    }
                    column(Cheque_year1; Cheque_year1)
                    {

                    }
                    column(Cheque_year2; Cheque_year2)
                    {

                    }
                    column(Cheque_year3; Cheque_year3)
                    {

                    }
                    column(Cheque_year4; Cheque_year4)
                    {
                    ...
                    begin
                        if not TestPrint then begin
                            with GenJnlLine do begin
                                ...
                                CheckLedgEntry."External Document No." := UseCheckNo;
                                //PV
                                ...
                                //PV
                                CheckLedgEntry.Narration := Narration;
                                CheckLedgEntry."Pre Assigned No." := "Pre Assigned No.";
                                CheckLedgEntry.PayeeName := PayeeName;
                                CheckLedgEntry.VoidRemarks := VoidRemarks;
                                //PV
                                ...
                                if FoundLast then begin
                                    ...
                                    VoidText := '';
                                    //PV
                                    //FacadeMgt.InitTextVariable;
                                    //FacadeMgt.FormatNoText(DescriptionLine,CheckLedgEntry.Amount,BankAcc2."Currency Code",FALSE,TRUE,FALSE);
                                    InitTextVariable();
                                    FormatNoTextV2(DescriptionLine, CheckLedgEntry.Amount, BankAcc2."Currency Code", FALSE, TRUE, FALSE);
                                    //PV
                                    //PV(+)
                                    if StrLen(DescriptionLine[1]) > 50 then begin
                                        DesLength := 50;
                                        BreakPoint := 0;
                                        while BreakPoint < 1 do begin
                                            if COPYSTR(DescriptionLine[1], DesLength, 1) = ' ' then
                                                BreakPoint := 2
                                            else
                                                DesLength := DesLength - 1;
                                        end;
                                        DesLength += 1;
                                        ExcessDes := COPYSTR(DescriptionLine[1], DesLength, 80);
                                        DesLength -= 2;
                                        DescriptionLine[1] := COPYSTR(DescriptionLine[1], 1, DesLength);
                                        DescriptionLine[2] := ExcessDes + ' ' + DescriptionLine[2];
                                    end;
                                    if StrLen(DescriptionLine[2]) > 50 then begin
                                        DesLength := 50;
                                        BreakPoint := 0;
                                        while BreakPoint < 1 do begin
                                            if COPYSTR(DescriptionLine[2], DesLength, 1) = ' ' then
                                                BreakPoint := 2
                                            else
                                                DesLength := DesLength - 1;
                                        end;
                                        DesLength += 1;
                                        ExcessDes := COPYSTR(DescriptionLine[2], DesLength, 80);
                                        DesLength -= 2;
                                        DescriptionLine[2] := COPYSTR(DescriptionLine[2], 1, DesLength);
                                        DescriptionLine[3] := ExcessDes;
                                    end;
                                    //PV(-)
                                end else begin
                ...
                begin
                    ...
                    if not TestPrint then begin
                        if UseCheckNo <> GenJnlLine."External Document No." then begin//PV
                            GenJnlLine3.Reset();
                            ...
                            GenJnlLine3.SetRange("External Document No.", UseCheckNo);//PV
                            if GenJnlLine3.Find('-') then
                                GenJnlLine3.FieldError("External Document No.", StrSubstNo(Text013, UseCheckNo));//PV
                        end;

                        if ApplyMethod <> ApplyMethod::MoreLinesOneEntry then begin
                            GenJnlLine3 := GenJnlLine;
                            //GenJnlLine3.TestField("Posting No. Series", '');
                            GenJnlLine3."External Document No." := UseCheckNo;//PV
                            ...
                            if GenJnlLine2.Find('-') then begin
                                ...
                                repeat
                                    ...
                                    //GenJnlLine3.TestField("Posting No. Series", '');//PV
            ...
            begin
                ...
                //PV(+)
                cheque_day := DATE2DMY(GenJnlLine."Posting Date", 1);
                cheque_month := DATE2DMY(GenJnlLine."Posting Date", 2);
                cheque_year := DATE2DMY(GenJnlLine."Posting Date", 3);
                cheque_year := cheque_year;

                IF (cheque_month DIV 10) = 0 THEN BEGIN
                    Cheque_month1 := 0;
                    Cheque_month2 := cheque_month;
                END ELSE BEGIN
                    Cheque_month1 := (cheque_month DIV 10);
                    Cheque_month2 := (cheque_month MOD 10);
                END;

                IF (cheque_day DIV 10) = 0 THEN BEGIN
                    Cheque_day1 := 0;
                    Cheque_day2 := cheque_day;
                END ELSE BEGIN
                    Cheque_day1 := (cheque_day DIV 10);
                    Cheque_day2 := (cheque_day MOD 10);
                END;

                Cheque_year1 := FORMAT(cheque_year DIV 1000);
                Cheque_year2 := FORMAT(((cheque_year MOD 1000) DIV 100));
                Cheque_year3 := ((cheque_year MOD 100) DIV 10);
                Cheque_year4 := cheque_year MOD 10;

                IF fullYear = FALSE THEN BEGIN
                    Cheque_year1 := '';
                    Cheque_year2 := '';
                END;
                //PV(-)
                clear(Seal02A);
                IF (PrintSeal02) THEN BEGIN
                    Seal02A := ' A/C PAYEE ONLY';
                    line := '...........................';
                    IF (Crossed) THEN
                        Seal02A := Seal02A + '  NOT NEGOTIABLE';
                END ELSE
                    IF (Crossed) THEN BEGIN
                        Seal02A := ' NOT NEGOTIABLE';
                        line := '...........................';
                    END ELSE BEGIN
                        Seal02A := '';
                        line := '';
                ...
                line1 := DOT_LINES;
                //Director := AUTH_SIGN; PV 
                //CompName := CompanyInfo.Name;

                /*
                IF SingleCompanySealPrint OR DoubleCompanySealPrint THEN BEGIN
                    line1 := DOT_LINES;
                    Director := AUTH_SIGN;
                    CompName := CompanyInfo.Name;
                END
            ...
            begin
                Copy(VoidGenJnlLine);
                CompanyInfo.Get();
                //Message('%1', CompanyInfo."VAT Registration No.");
                if not TestPrint then begin
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field("Print Full Year"; fullYear)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Print Full Year';
                        ToolTip = 'Specifies if the full year is printed on the check.';
                    }
                    field("Authorized Signature"; AuthorizedSing)//PV
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Authorized Signature';
                        ToolTip = 'Specifies if the authorized signature is printed on the check.';
                    }
                    /*
                ...
                group("Crossed Checks")
                {

                    field(PrintSeal02; PrintSeal02)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'A\C Payee Only';
                        ToolTip = 'Specifies if the A/C Payee Only text is printed on the check.';
                    }

                    field(Crossed; Crossed)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Not Negotiable';
                        ToolTip = 'Specifies if the Not Negotiable text is printed on the check.';
                    }
                    field(NoofValidDays; NoofValidDays)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Valid for Days only';
                        ToolTip = 'Specifies the number of days that the check is valid for.';
                    }
    ...
    begin
        ...
        InitTextVariable();
        //PV
        //NoOfValidDaysTxt := ' VALID FOR ' + FORMAT(NoofValidDays) + ' DAYS ONLY';
        NoOfValidDaysTxt := '';
        //PV

        //PV(+)
        if AuthorizedSing then begin
    ...
    var
        ...
        DescriptionLineNew: array[3] of Text[55];
        DocNo: Text[30];
        ExtDocNo: Text[35];
        VoidText: Text[30];
        LineAmount: Decimal;
        ...
        Cheque_day1: Integer;
        Cheque_day2: Integer;
        Cheque_month1: Integer;
        Cheque_month2: Integer;
        Cheque_year1: Text[50];
        Cheque_year2: Text[50];
        Cheque_year3: Integer;
        Cheque_year4: Integer;
        fullYear: Boolean;
        AuthorizedSing: Boolean;//PV
        cheque_day: Integer;
        cheque_month: Integer;
        cheque_monthFormat: Text[10];
        cheque_year: Integer;
        Crossed: Boolean;
        Counterfiet: Boolean;
        line: Text[200];
        ...
        AUTH_SIGN: Label 'Director Signature(s)';
        DOT_LINES: Text;
        Seal02A: Text[50];
        PrintSeal02: Boolean;
        SingleCompanySealPrint: Boolean;
        DoubleCompanySealPrint: Boolean;
        NoCompanySeal: Boolean;
        Director: Text;
        CompName: Text;
        NoofValidDays: Integer;
        NoOfValidDaysTxt: Text;
