    ...
    layout
    {
        area(Content)
        {
            ...
            cuegroup(Approvals)
            {
                ...
                Caption = 'Approvals';
                field("All Approval Pending SQ"; Rec."All Approval Pending SQ")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the All Approval Pending Sales Quotes field.';
                    DrillDownPageID = "4HC All PendingApproval";
