page 50122 "4HC Senior Sales Manager RC"
{
    PageType = RoleCenter;
    ApplicationArea = All;
    ...
    layout
    {
        area(RoleCenter)
        {
            ...
            part(Control1; "4HC Senior Sales Manager Cues")
            {
                ApplicationArea = RelationshipMgmt;
            }
...
profile SeniorSalesManager
{
    RoleCenter = "4HC Senior Sales Manager RC";
    Caption = 'Senior Sales Manager';
}