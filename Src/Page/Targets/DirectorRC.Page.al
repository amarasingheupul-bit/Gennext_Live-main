page 50117 "4HC Director RC"
{
    ...
    layout
    {
        area(RoleCenter)
        {
            ...
            part(Control1; "4HC Director Cues")
            {
                ApplicationArea = RelationshipMgmt;
            }
            ...
            part("4HC Sales Targets"; "4HC Sales Target RC List")
            {
                ApplicationArea = All;
            }
            ...
            part("Solution Targets"; "4HC Solution Target RC Part")
            {
                ApplicationArea = All;
            }
            part("Brand Targets"; "4HC Brand Target RC Part")
            {
                ApplicationArea = All;
            }
        }
