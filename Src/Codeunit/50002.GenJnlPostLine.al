codeunit 50110 "Gen. Jnl.-Post Line SC"
{
    ...
    begin
        ...
        //VATEntry.SetVATDateFromGenJnlLineChqMgt(GenJnlLine);
            ...
            case GenJnlLine."Bank Payment Type" of
                GenJnlLine."Bank Payment Type"::"Computer Check":
                    begin
                        ...
                        CheckLedgEntry.SETRANGE("Check No.", GenJnlLine."External Document No."); //PV
                        if CheckLedgEntry.FindSet() then
                            repeat
                                ...
                                CheckLedgEntry2."Document No." := BankAccLedgEntry."Document No."; //PV
    ...
    begin
        ...
        //TempVATEntry.SetVATDateFromGenJnlLineChqMgt(GenJnlLine);
