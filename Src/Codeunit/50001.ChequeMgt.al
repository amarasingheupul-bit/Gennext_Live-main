codeunit 50106 ChequeMgt
{
    ...
    procedure VoidCheck(var GenJnlLine: Record "Gen. Journal Line"; var VRemarks: Text[200])
    var
    ...
    begin
        ...
        if GenJnlLine2.Find('-') then
            repeat
                ...
                then
                    ...
                    GenJnlLine2."External Document No." := '';
                    GenJnlLine2."VoidRemarks" := '';
                    //GenJnlLine2."Document No." := ''; PV
                    //GenJnlLine2."Document Date" := 0D; PV
        ...
        CheckLedgEntry2.SetRange("Check No.", GenJnlLine."External Document No.");//PV
        ...
        CheckLedgEntry2."VoidRemarks" := VRemarks;//PV
        VRemarks := '';//PV
    ...
    var
        ConfirmFinancialVoid: Page "Confirm Financial Void SC";//PV
    ...
    begin
        ...
        //PV
        IF ConfirmFinancialVoid.GetVoidRemarks() = '' THEN
        ...
        if ConfirmFinancialVoid.GetVoidDate() = CheckLedgEntry."Check Date" then
            ClearBankLedgerEntry(BankAccLedgEntry3, ConfirmFinancialVoid.GetVoidRemarks());//PV added void remarks para 
        ...
        MarkCheckEntriesVoid(CheckLedgEntry, ConfirmFinancialVoid.GetVoidDate(), ConfirmFinancialVoid.GetVoidRemarks());//PV Added void remarks para
        Commit();
    ...
    local procedure MarkCheckEntriesVoid(var OriginalCheckLedgerEntry: Record "Check Ledger Entry"; VoidDate: Date; VoidRemarks: Text[100])
    var
    ...
    local procedure ClearBankLedgerEntry(var BankAccountLedgerEntry: Record "Bank Account Ledger Entry"; VRemarks: Text[100])
    begin
        ...
        BankAccLedgEntry3."VoidRemarks" := VRemarks; //PV
